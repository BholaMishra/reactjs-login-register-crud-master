                        ...
                        <div className="container-fluid">
                            <Paper sx={{ width: "200%", mb: 0 }}>
                                ...
                                <div className="AddEpp" style={{ border: 'none', color: 'revert' }}>
                                    ...
                                    {/* /auctionadd 
                                    <Link variant="contained" color="primary" to={""} style={{ border: 'none', color: 'white' }}>Add Service</Link>
                                </Button> */}
                                </div>
                                {/* <br /> */}
                                                                ...
                                                                <div className="container">
                                                                    <div class="row">
                                                                        ...
                                                                        <div className="col col-lg-3" style={{ marginRight: '-121px', width: "30px", height: "30px" }}>
                                                                            ...
                                                                            {data.active == 1 && <i value={data.icon} id='iconname' name='icon' className="fa fa-ban" onclick={Deleteuser} onClick={() => Deleteuser(data.userEPPSubscription)} aria-hidden="true" />}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </TableCell>
...
// React.useEffect((e) => {
//     axios.get(`https://qaapi.jahernotice.com/api/gettpuserdata`+` ${UserId}?_=1663608645944`).then((response) => {
//         setData(response.data.data);
//     console.log("Bhola", response.data.data)
//     // setUserId()
// });
